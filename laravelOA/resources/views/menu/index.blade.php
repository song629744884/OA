...
<script>
    new Vue({
        ...
        methods: {
            ...
            getMenuList(){
                let that = this;
                this.$http.get('{{ url('menu/menuData') }}').then(function(res){
            ...
            getTopMenuList(){
                let that = this;
                this.$http.get('{{ url('menu/topMenu') }}').then(function(res){
                    if (res.body.code == '1') {
            ...
            setSubmit: function (formName) {
                ...
                that.$refs[formName].validate((valid) => {
                    if (valid) {
                        that.$http.post('{{ url('menu/save') }}',that.editForm,{headers:{'X-CSRF-TOKEN': '{{ csrf_token() }}'},}).then(function(res){
                            //console.log(res);
                            if (res.body.code == '1') {
                                that.getMenuList();
                                that.getTopMenuList();
